...
public class InventoryManager : SingletonMonoBehaviour<InventoryManager>, ISaveable
{
    ...
    protected override void Awake() 
    {
        ...
        //Get unique ID for gameObject and create and save data object
    ...
    /// <summary>
    /// Get the item type description for an item type - returns the item type description as a string for a given item type.
    /// </summary>
    ...
    /// <summary>
    /// Add an item of type itemCode to the inventory list for the invenrtoryLocation
    /// </summary>
    ...
    /// <summary>
    /// Add item to the position of the inventory
    /// </summary>
