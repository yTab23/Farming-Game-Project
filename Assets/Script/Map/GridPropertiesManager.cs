...
public class GridPropertiesManager : SingletonMonobehaviour<GridPropertiesManager>, ISaveable
{
    ...
    /// <summary>
    /// Get the grid property details for the tile at (gridX, gridY). If no grid property details exist null is returned and can assume that all grid peropty details values are null or false.
    /// <summary>   
   ...
   private void ConnectWateredGround(GridPropertyDetails gridPropertyDetails)
    ...
    private void InitializeGridProperties()
    {
        ...
        foreach (SO_GridProperties so_GridProperties in so_gridPropertiesArray)
        {
            ...
            //If starting scene set the gridProopertyDictionmary member variable to the current iteration.
    ...
    public void ISaveableRestoreScene(string sceneName)
    {
        ...
        if(GameObjectSave.sceneData.TryGetValue(sceneName, out SceneSave sceneSave))
        {
            ...
            // Update first timne scene loaded bool
    ...
    /// <summary>
    /// Set the grid property details to gridPropertyDetails for the tile at (gridX, gridY) for the current scene.
    /// <summary> 
    ...
    private void AdvanceDay(int gameYear, Season gameSeason, int gameDay, string gameDayOfWeek, int gameHour, int gameMinute, int gameSecond)
    {
        ...
        foreach (SO_GridProperties so_GridProperties in so_gridPropertiesArray)
        {
            //Get gridPropertyDetails dictionary scene
